...
subtitle: "Exploring the application of a genetic algorithm to grow a population of linkge structures whose traces approximate a provided set of parametric curves.  "
