...
_This project was built during my time at [Sylebra Capital](https://www.sylebra.com/), a technology-focused investment firm in Hong Kong. The goal was to automate the thinning of a large investible universe — roughly 5,000 tickers — using the linguistic content of earnings transcripts rather than manual analyst review. The full pipeline and proprietary training data can't be shared publicly, but the prediction head below shows the core approach. If you want more detail, reach out._
